...
function ParallaxSection({children}: Props) {
    ...
    return (
        <div ref={sectionRef} className="bg-[#1b1b1b] w-full h-full relative overflow-hidden">
            <div ref={containerRef} className='container w-full h-full relative scale-150'>
               {children}
            </div>
        </div>
    )
